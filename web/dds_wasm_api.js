 ...
 * @noinline
 */ var isFileURI = (filename) => (typeof filename === 'string' ? filename : (filename && filename.href) || '').startsWith('file://');
...
function findWasmBinary() {
  return locateFile("dds_wasm_api_cc.wasm");
}
...
var isCppExceptionObject = object => object instanceof WebAssembly.Exception;
...
var ___increment_uncaught_exception = makeInvalidEarlyAccess("___increment_uncaught_exception");
...
var incrementUncaughtExceptionCount = makeInvalidEarlyAccess("incrementUncaughtExceptionCount");
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports["__increment_uncaught_exception"] != "undefined", "missing Wasm export: __increment_uncaught_exception");
  ...
  ___increment_uncaught_exception = incrementUncaughtExceptionCount = createExportWrapper("__increment_uncaught_exception", 0);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createDdsApiModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createDdsApiModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createDdsApiModule);
